...
class Test_Wizard(Chai):
    ...
    def test_wizard_format_no_iob(self):
        ...
        timesteps = [tools.convert_ISO_to_epoch('2015-01-01 15:00:00',
                                                '%Y-%m-%d %H:%M:%S'),
    ...
    def test_wizard_format_with_iob(self):
        ...
        gluc = [100]
        carbs = [90]
        timesteps = [tools.convert_ISO_to_epoch('2015-01-01 00:00:00',
                                                '%Y-%m-%d %H:%M:%S')]
    ...
    def test_insulin_sensitivity(self):
        ...
        timesteps = [tools.convert_ISO_to_epoch('2015-01-01 04:30:00',
                                                '%Y-%m-%d %H:%M:%S'),
    ...
    def test_no_wizard(self):
        ...
        gluc = [87, 201, 164, 180]
        carbs = [96, 82, 17, 53]
        timesteps = [tools.convert_ISO_to_epoch('2015-01-01 04:00:00',
                                                '%Y-%m-%d %H:%M:%S'),
